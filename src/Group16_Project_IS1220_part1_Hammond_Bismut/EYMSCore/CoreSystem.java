...
import Group16_Project_IS1220_part1_Hammond_Bismut.notifications.*;
import Group16_Project_IS1220_part1_Hammond_Bismut.users.*;
import Group16_Project_IS1220_part1_Hammond_Bismut.users.Client.CardType;
import Group16_Project_IS1220_part1_Hammond_Bismut.users.Client.Contact;
import Group16_Project_IS1220_part1_Hammond_Bismut.fidelitycard.LotteryCard;
import Group16_Project_IS1220_part1_Hammond_Bismut.menu.*;
import Group16_Project_IS1220_part1_Hammond_Bismut.orders.*;
import Group16_Project_IS1220_part1_Hammond_Bismut.storing.*;
...
public class CoreSystem{
	 ...
	 */
	public Restaurant openInRestaurant (String restaurantName){
		...
		return new Restaurant("Restaurant inconnu");
	}
	...
	private static void executeScenario(int numero){
		...
		if(numero>1 && numero<15){
			...
			restaurant = system.openInRestaurant("Le Sun Cafe");
		}
		switch(numero){
		case 1 :
		...
		case 14:
			...
			restaurant.login("bob2005", "333333");
			restaurant.logout();
			Restaurant restaurant2 = system.openInRestaurant("Le Parapente");
	 ...
	 */
	private static void initializeSituation(){
